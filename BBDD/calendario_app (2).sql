...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-01-2026 a las 11:00:01
...
--
-- Estructura de tabla para la tabla `etiquetas_grupos`
--

CREATE TABLE `etiquetas_grupos` (
  `id_etiqueta` int(11) NOT NULL,
...
--
-- Indices de la tabla `etiquetas_grupos`
--
ALTER TABLE `etiquetas_grupos`
  ADD PRIMARY KEY (`id_etiqueta`,`id_grupo`),
  ADD KEY `fk_grupo_etiqueta` (`id_grupo`);
...
ALTER TABLE `eventos`
  ...
  ADD KEY `fk_evento_etiqueta` (`id_etiqueta`);
...
--
-- Filtros para la tabla `etiquetas_grupos`
--
ALTER TABLE `etiquetas_grupos`
  ADD CONSTRAINT `fk_etiqueta_grupo` FOREIGN KEY (`id_etiqueta`) REFERENCES `etiquetas` (`id_etiqueta`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_grupo_etiqueta` FOREIGN KEY (`id_grupo`) REFERENCES `grupos` (`id_grupo`) ON DELETE CASCADE;
...
--
ALTER TABLE `eventos`
  ADD CONSTRAINT `fk_evento_etiqueta` FOREIGN KEY (`id_etiqueta`) REFERENCES `etiquetas` (`id_etiqueta`) ON UPDATE CASCADE,
