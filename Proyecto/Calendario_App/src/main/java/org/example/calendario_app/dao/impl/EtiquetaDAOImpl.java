...
public class EtiquetaDAOImpl implements EtiquetaDAO {
    ...
    public int save(Etiqueta etiqueta, int idUsuario, Integer idGrupo) {
        String insertEtiqueta = "INSERT INTO etiquetas (nombre, color, id_grupo) VALUES (?, ?, ?)";
