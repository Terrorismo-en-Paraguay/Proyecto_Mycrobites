...
/**
 * Fragmento principal del calendario.
 * Funcionalidades:
 * - Tres modos de vista: Mes, Semana, Día
 * - Navegación entre fechas
 * - Búsqueda de eventos con resultados ordenados
 * - Visualización de eventos en grid horario (semana/día)
 * - Visualización de eventos en lista (mes)
 * - FAB expandible para crear eventos, grupos y etiquetas
 * - Drawer de navegación con filtros
 * - Integración con EventViewModel para datos y filtros
 */
...
class CalendarFragment : Fragment() {
    ...
    private var idUsuario: Int = 0 // Se establecerá desde la sesión
