 ...
 * Permite crear una cuenta con validación en tiempo real.
 * Funcionalidades:
 * - Validación de campos (nombre, apellido, email, contraseña)
 * - Verificación de coincidencia de contraseñas
 * - Toggle de visibilidad de contraseñas
 * - Habilitación dinámica del botón de registro
...
class RegisterFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Configurar TextWatchers para validación
        ...
        viewModel.registerResult.observe(viewLifecycleOwner) { result ->
            when (result) {
                is RegisterResult.Success -> {
                    ...
                    context?.let { ctx ->
                        NotificationManager.notifyRegistrationSuccessful(
                            context = ctx,
